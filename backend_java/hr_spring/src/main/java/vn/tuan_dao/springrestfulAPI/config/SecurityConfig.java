...
public class SecurityConfig {
    ...
    // CORS cho phép frontend truy cập API, có thể điều chỉnh theo môi trường 
    @Bean
    CorsConfigurationSource corsConfigurationSource() {
        CorsConfiguration configuration = new CorsConfiguration();
        // Cho phép các origin của frontend (có thể thêm domain production khi deploy)
    ...
    // Cấu hình bảo mật chính, sử dụng JWT và phân quyền theo PermissionAuthorizationManager
    @Bean
