...
export const router = createBrowserRouter([
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: "directory",
                lazy: () => import("@/features/directory/components/EmployeeDirectory"),
            },
            {
                path: "attendance",
                lazy: () => import("@/features/attendance/components/AttendanceManagement"),
            },
            {
                path: "payroll",
                lazy: () => import("@/features/payroll/components/PayrollCompensation"),
            },
            {
                path: "employees/:id",
                lazy: () => import("@/features/user/components/EmployeeProfile"),
            },
        ],
    },
]);
